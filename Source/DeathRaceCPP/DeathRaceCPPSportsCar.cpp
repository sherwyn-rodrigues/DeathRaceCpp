...
#include "DeathRaceCPPSportsWheelFront.h"
#include "DeathRaceCPPSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ADeathRaceCPPSportsCar::ADeathRaceCPPSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UDeathRaceCPPSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UDeathRaceCPPSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UDeathRaceCPPSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UDeathRaceCPPSportsWheelRear::StaticClass();
