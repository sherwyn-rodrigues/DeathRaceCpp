...
#include "DeathRaceCPPOffroadCar.h"
#include "DeathRaceCPPOffroadWheelFront.h"
#include "DeathRaceCPPOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

ADeathRaceCPPOffroadCar::ADeathRaceCPPOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UDeathRaceCPPOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UDeathRaceCPPOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UDeathRaceCPPOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UDeathRaceCPPOffroadWheelRear::StaticClass();
